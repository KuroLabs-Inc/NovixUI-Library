...
local NovixUI = {}
function NovixUI:MakeNotify(NotifyConfig)
	local NotifyConfig = NotifyConfig or {}
	NotifyConfig.Title = NotifyConfig.Title or "NovixUI"
	...
	task.spawn(function()
		...
		if not PlayerGui.NotifyGui:FindFirstChild("NotifyLayout") then
			...
			NotifyLayout.Parent = PlayerGui.NotifyGui
			local Count = 0
			PlayerGui.NotifyGui.NotifyLayout.ChildRemoved:Connect(function()
				Count = 0
				for i, v in PlayerGui.NotifyGui.NotifyLayout:GetChildren() do
					TweenService:Create(
						v,
		...
		NotifyFrame.Parent = PlayerGui.NotifyGui.NotifyLayout
...
function NovixUI:MakeGui(GuiConfig)
	local GuiConfig = GuiConfig or {}
	GuiConfig.NameHub = GuiConfig.NameHub or "NovixUI"
	GuiConfig.Description = GuiConfig.Description or "NovixUI | Redesigned UI Library"
	GuiConfig.Color = GuiConfig.Color or Color3.fromRGB(255, 0, 255)	
	GuiConfig["Tab Width"] = GuiConfig["Tab Width"] or 120
	GuiConfig.Image = GuiConfig.Image or "17681429652"
	local GuiFunc = {}

	local NovixGui = Instance.new("ScreenGui");
	local DropShadowHolder = Instance.new("Frame");
	local DropShadow = Instance.new("ImageLabel");
	...
	NovixGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    NovixGui.Name = "NovixGui"
    NovixGui.ResetOnSpawn = false
    NovixGui.Parent = PlayerGui
	...
	DropShadowHolder.ZIndex = 0
	DropShadowHolder.Name = "DropShadowHolder"
	DropShadowHolder.Parent = NovixGui
	
  DropShadowHolder.Position = UDim2.new(0, (NovixGui.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0, (NovixGui.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
	DropShadow.Image = "rbxassetid://6015897843"
	...
	function GuiFunc:DestroyGui()
		if PlayerGui:FindFirstChild("NovixGui") then 
			PlayerGui:FindFirstChild("NovixGui"):Destroy()
		end
		if CoreGui:FindFirstChild("NovixToggle") then
			CoreGui:FindFirstChild("NovixToggle"):Destroy()
		end
		if CoreGui:FindFirstChild("NovixConfirm") then
			CoreGui:FindFirstChild("NovixConfirm"):Destroy()
		end
	end
	...
	Close.Activated:Connect(function()
		...
		UICornerC.Parent = ConfirmFrame

		local TitleLabel = Instance.new("TextLabel")
		TitleLabel.Font = Enum.Font.GothamBold
		TitleLabel.Text = "NovixUI Hub"
		...
		ContentLabel.Text = "Wanna Destroy The UI?"
		ContentLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
		ContentLabel.TextSize = 14
		ContentLabel.BackgroundTransparency = 1
		ContentLabel.Size = UDim2.new(1, 0, 0, 25)
		ContentLabel.Position = UDim2.new(0, 0, 0, 55)
		ContentLabel.Parent = ConfirmFrame
		...
		YesButton.Position = UDim2.new(0, 30, 0, 100)
		YesButton.Size = UDim2.new(0, 100, 0, 30)
		YesButton.Parent = ConfirmFrame

		local UICornerY = Instance.new("UICorner")
		UICornerY.CornerRadius = UDim.new(0, 6)
		UICornerY.Parent = YesButton
	...
	function Tabs:CreateTab(TabConfig)
		...
		function Sections:AddSection(Title)
			...
			function Items:AddDropdown(DropdownConfig)
				...
				DropdownTitle.TextColor3 = Color3.fromRGB(231, 231, 231)
				...
				OptionImg.ImageColor3 = Color3.fromRGB(231, 231, 231)
...
function DropdownFunc:Set(Value)
    ...
    if DropdownConfig.Callback and typeof(DropdownConfig.Callback) == "function" then
        DropdownConfig.Callback(DropdownFunc.Value)
				...
				function DropdownFunc:AddOption(OptionName)
					...
					OptionText.TextColor3 = Color3.fromRGB(231, 231, 231)
	...
	-- Attach GuiFunc methods to Tabs so user can call Window:DestroyGui() etc.
	Tabs.DestroyGui = function() GuiFunc:DestroyGui() end
	Tabs.ToggleUI = function() GuiFunc:ToggleUI() end
