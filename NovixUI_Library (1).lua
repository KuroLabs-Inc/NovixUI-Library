...
function NovixUI:MakeGui(GuiConfig)
  ...
  DropShadowHolder.Position = UDim2.new(0, (NovixGui.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0, (NovixGui.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
	...
	function GuiFunc:DestroyGui()
		if CoreGui:FindFirstChild("NovixGui") then 
			NovixGui:Destroy()
		end
		local CoreGuiService = game:GetService("CoreGui")
		if CoreGuiService:FindFirstChild("NovixToggle") then
			CoreGuiService:FindFirstChild("NovixToggle"):Destroy()
		end
		if CoreGuiService:FindFirstChild("NovixConfirm") then
			CoreGuiService:FindFirstChild("NovixConfirm"):Destroy()
		end
	end
